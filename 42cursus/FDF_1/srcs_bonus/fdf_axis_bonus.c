...
/*   Updated: 2024/01/16 20:14:35 by tajeong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fdf_init_axis(t_info *info)
{
	...
	if (info->image_axis == NULL)
		exit(EXIT_FAILURE);
	info->axis[0] = (t_data){0, 0, 0, 0, 0, 0, 0, 0xFFFFFF};
	info->axis[1] = (t_data){0, 0, 0, 0, 0, 0, 0, 0xFFFFFF};
	info->axis[2] = (t_data){0, 0, 0, 0, 0, 0, 0, 0xFFFFFF};
	info->axis[3] = (t_data){500, 0, 0, 0, 0, 0, 0, 0xFF0000};
	info->axis[4] = (t_data){0, 500, 0, 0, 0, 0, 0, 0x00FF00};
	info->axis[5] = (t_data){0, 0, 500, 0, 0, 0, 0, 0x0000FF};
