...
AForm::NotSignedException::NotSignedException(): std::exception() {
	// 구현체 없음
}
...
AForm::NotSignedException::NotSignedException(const AForm::NotSignedException &other): std::exception(other) {
	// 구현체 없음
}

AForm::NotSignedException &AForm::NotSignedException::operator=(const AForm::NotSignedException &other) {
	if (this == &other)
		return *this;
	std::exception::operator=(other);
	return *this;
